...
impl CaptureMode {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Self::Freehand => "Freehand (soon)",
            Self::Window => "Window (soon)",
...
/// Selectors emit normalized image bounds, independent of output scale.
/// Window selection can emit the same bounds; freehand needs a path/mask payload.
pub struct OutputSelection<Message> {
